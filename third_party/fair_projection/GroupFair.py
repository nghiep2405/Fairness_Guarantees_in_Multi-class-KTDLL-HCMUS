...
class GFair:
    ...
    def fit(self, X,y,s, sample_weight):
        ...
        * s = group attribute array
        ...
        # one-hot-encode y
        self.enc_y = OneHotEncoder(handle_unknown='ignore',categories = [self.y_categories_],sparse_output=False)
        ...
        # one-hot-encode s
        self.enc_s = OneHotEncoder(handle_unknown='ignore',categories = [self.s_categories_],sparse_output=False)
    ...
    def buildG(self, X,constraints,y=None,s=None):
        ...
        ################################################
        # Deterministic adapter: do not inject stochastic jitter into constraints.
        ################################################
        self.G = G_temp
        return G_temp
    ...
    def project(self,X,y=None,s=None,constraints=[('meo',.1)],rho=2,max_iter=1000,use_y = False,method='tf', verbose=False):
        '''
